...
class Fktp extends StatefulWidget {
  @override
  _FktpState createState() => _FktpState();
}

class _FktpState extends State<Fktp> {
  var username = '';
  var id_user = '';
  ...
  Future<void> submitFKTP() async {
    setState(() {
      isVisible = true;
    });

    var url = Uri.http(
        "e-sibling.hikmahasiabatamtour.com", '/api/fktp.php', {'q': '{https}'});
